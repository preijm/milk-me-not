	...
	extend: {
		colors: {
			...
			story: {
				...
				'tint-sand': 'hsl(var(--story-tint-sand) / <alpha-value>)',
				'tint-clay': 'hsl(var(--story-tint-clay) / <alpha-value>)',
				'tint-mint': 'hsl(var(--story-tint-mint) / <alpha-value>)',
				'tint-sky': 'hsl(var(--story-tint-sky) / <alpha-value>)',
