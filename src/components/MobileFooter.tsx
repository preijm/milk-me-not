      ...
      <div className="bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-lg">
        <div className="px-2 py-2">
          <div className="grid grid-cols-5 gap-1">
            ...
            <Link to="/notifications" className={`flex flex-col items-center justify-center gap-1 py-1.5 rounded-lg transition-colors ${getLinkClass("/notifications")}`} style={getLinkStyle("/notifications")}>
